...
const Contact = () => {
  return (
    <div name = 'contact' className='w-full h-full py-72 bg-almond flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/1575d85d-5d25-4d12-925b-8d0d2a4b407d" className='flex flex-col max-w-[600px] w-full'>
          ...
          <input className='my-4 p-2 bg-almond-800 ' type="email" placeholder='Email' name='email'/>
