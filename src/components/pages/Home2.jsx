  ...
  return (
    <div name="home" className="w-full h-screen bg-almond">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center items-center h-full ">
        <h1 className="text-4xl text-7x1 font-bold sm:block border-b-4 border-pink-600">
          Samuel Beal
        </h1>

        <div className="">
          {/* <p className=" mt-2 mb-3 text-2xl pt-1 font-extrabold tracking-tight text-text-color sm:text-4xl flex">
            <p className=" hidden md:block whitespace-nowrap text-3xl font-extrabold">
              &lt;
              <span className="font-extrabold text-xl text-pink-600">div</span>
              &gt;
              <span className="text-2xl mx-2 font-extrabold leading-7 ">
                I build
              </span>
            </p>
            <p className=" hidden md:block text-xs pt-3 font-black tracking-wide">
              <TypeAnimation
                sequence={[
            ...
            <p className=" hidden md:block text-2xl font-bold pt-1 ">
              &lt;/
        ...
        <p className="hidden md:block text-center text-lg leading-8 py-2 max-w-[700px] ">
        ...
        {/* Social icons */}
        <div className="py-4 grid grid-cols-2 text-4xl font-bold inline">
          <div className="mx-3 ">
